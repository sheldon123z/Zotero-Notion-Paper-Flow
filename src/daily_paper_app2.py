...
category_map = {
    ...
    'LLM':["J9BJ29CU",personal_default],
    'CoT':["HQW9EIWW",personal_default]
}

category_map_group = {
    'NLP': ["HWUS28XJ", group_default], # 
    'RL': ["SQV644CH", group_default],# 
    'MARL': ["P647DPI4", group_default], #
    'MTS': ["234T2DFI", group_default], 
    '多模态': ["PVFEWZ7I", group_default],
    'CV': ["2SRRSPXA", group_default],
    "LLM":["H3J3Q73F",group_default],
    'CoT':["7TB47HCZ",group_default]
}
